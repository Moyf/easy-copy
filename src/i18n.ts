...
export type TranslationKey = 
	...
	| 'link-format-page-desc' | 'heading-link' | 'note-link'
...
export const translations: Record<Language, Record<TranslationKey, string>> = {
	[Language.EN]: {
		...
		// 设置界面
		'format': 'Copy format',
		'link-format-page-desc': 'Paste-time path resolution and heading/note link display text.',
		...
		'resolve-link-path-on-paste-desc': 'Regenerate the link path at paste time based on the destination file. Under "Follow Obsidian settings", uses your link format in "Files and links" settings. Otherwise, use shortest link.',
		...
		'special-format': 'Advanced options',
		'special-format-desc': 'Embed markers, Wiki brackets, and display name regex.',
	...
	[Language.ZH]: {
		...
		// 设置界面
		'format': '复制格式',
		'link-format-page-desc': '粘贴时路径解析，以及标题/笔记链接的显示文本。',
		'heading-link': '标题链接',
		'note-link': '笔记链接',
		'block-id': '块ID',
		...
		'resolve-link-path-on-paste-desc': '粘贴时根据目标文件重新生成链接路径。使用"跟随 Obsidian 设置"时，沿用"文件与链接"设置中的链接格式；否则，使用最短链接。',
		...
		'special-format': '进阶选项',
		'special-format-desc': '嵌入标记、Wiki 括号与显示文本正则替换。',
	...
	[Language.ZH_TW]: {
		...
		// 設置界面
		'format': '複製格式',
		'link-format-page-desc': '貼上時路徑解析，以及標題/筆記連結的顯示文本。',
		'heading-link': '標題連結',
		'note-link': '筆記連結',
		'block-id': '塊ID',
		...
		'resolve-link-path-on-paste-desc': '貼上時根據目標檔案重新生成連結路徑。使用「跟隨 Obsidian 設定」時，沿用「檔案與連結」設定中的連結格式；否則，使用最短連結。',
		...
		'special-format': '進階選項',
		'special-format-desc': '嵌入標記、Wiki 括號與顯示文本正規表示式替換。',
