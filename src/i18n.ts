...
export const translations: Record<Language, Record<TranslationKey, string>> = {
	[Language.EN]: {
		...
		'block-display-word-limit': 'Block display text: Word limit',
		'block-display-word-limit-desc': 'Maximum number of words for space-separated text, such as English or Polish.',
		'block-display-char-limit': 'Block display text: Character limit',
		'block-display-char-limit-desc': 'Maximum number of characters for CJK text that does not rely on spaces between words, such as Chinese or Japanese.',
...
I want to extract:`,
	...
	[Language.ZH]: {
		...
		'block-display-word-limit': '块显示文本：按词截取上限',
		'block-display-word-limit-desc': '使用空格分词的文本（如英语、波兰语）最多保留的单词数',
		'block-display-char-limit': '块显示文本：按字符截取上限',
		'block-display-char-limit-desc': '不依赖空格分词的 CJK 文本（如中文、日文）最多保留的字符数',
...
我希望提取的是：`,
	...
	[Language.ZH_TW]: {
		...
		'block-display-word-limit': '塊顯示文本：按詞截取上限',
		'block-display-word-limit-desc': '使用空格分詞的文本（如英語、波蘭語）最多保留的單詞數',
		'block-display-char-limit': '塊顯示文本：按字符截取上限',
		'block-display-char-limit-desc': '不依賴空格分詞的 CJK 文本（如中文、日文）最多保留的字符數',
